...
export default function ToDos() {
  return (
    <div className="flex flex-col space-y-6">
      <div className="bg-red-300 w-[90%] sm:w-[50%] max-w-[330px] sm:max-w-[500px]  rounded-md border-2 border-black hover:border-slate-500 mx-auto font-form px-3 pt-2 pb-3 flex flex-col space-y-2 relative">
